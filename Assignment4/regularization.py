...
Regularization
Run command- python regularization.py
"""
...
for epoch in range(epochs):
    ...
    for i, (input, target) in pbar:
        ...
        if i % print_frequency == 0:
            ...
            freq += 1
        print("epoch ", epoch," i ",i," loss ",losses.avg," acc2 ",running_correct/100)
...
for epoch in range(epochs):
    ...
    for i, (input, target) in pbar:
        ...
        print("epoch ", epoch," i ",i," loss ",losses.avg," accuracy  ", top1.avg)
        logger.add_scalar('validation loss', losses.avg, epoch*n_total_steps + i)
